  ...
  return (
    <div className="Dashboard">
      <div className="intro">
        <div className="text">
          <p>
            <img src="https://avatars.githubusercontent.com/u/42247386?v=4" alt="" />
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/ConnectWithNoor/full-stack-app"
            >
              Github
            </a>
            ...
            <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/connectwithnoor/">
              LinkedIn
            </a>{' '}
            or{' '}
            <a target="_blank" rel="noreferrer" href="mailto:hello@connectwithnoor.dev">
              hello@connectwithnoor.dev
            </a>
            .
          </p>
        </div>
